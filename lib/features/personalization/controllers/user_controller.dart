...
class UserController extends GetxController {
  ...
  void deleteUserAccount() async {
    try {
      TFullScreenLoader.openLoadingDialog('Processing...', TImages.processingInfo);
  ...
  Future<void> reAuthenticateEmailAndPasswordUser() async {
    try{
      ...
      await AuthenticationRepository.instance.reAuthenticateWithEmailAndPassword(verifyEmail.text.trim(), verifyPassword.text.trim()).then((onValue) {
        //print("object");
      });
